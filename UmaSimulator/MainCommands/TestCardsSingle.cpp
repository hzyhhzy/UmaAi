...
void main_testCardsSingle()
{
  ...
  for (int toTestCardType = 0; toTestCardType < 5; toTestCardType++)
  {
    if (toTestCardType == 0)
    {
      ...
      cards = { 302074,302084,301874,300194,301724,-1 };//友人，--，力西野花，根巨匠，根乌拉拉，智麦昆
    }
    ...
    else if (toTestCardType == 1)
    {
      //1速1耐1力1根1智
      umaId = 101101;//草上飞，20速10力加成
      cards = { 302074,302064,302084,301874,301724,-1 };//友人，速强击，--, 力西野花，根巨匠，智麦昆
    }
    else if (toTestCardType == 2)
    {
      //1速1力2根1智
      umaId = 101101;//草上飞，20速10力加成
      cards = { 302074,302064,301874,300194,301724,-1 };//友人，速强击，--，根巨匠，根乌拉拉，智麦昆
    }
    ...
    else if (toTestCardType == 4)
    {
      //1速1力2根1智
      umaId = 101101;//草上飞，20速10力加成
      cards = { 302074,302064,302084,301874,300194,-1 };//友人，速强击，力西野花，根巨匠，根乌拉拉，--
    }
